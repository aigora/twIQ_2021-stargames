...
int File_out()    //guardar 
{
	...
	gotoxy(10,10);
    color(12);
    puts("Felicitaciones por romper el r谷cord"); 
    gotoxy(0,N+2);
    return 0;
}
...
int main(void)
{
    ...
    { 
        ...
        Sleep(200-score[2]*10);		//A medida que aumenta la puntuaci車n, aumenta la velocidad, cu芍ntos segundos para dormir, cuanto m芍s corto sea el tiempo entre par谷ntesis, m芍s r芍pido ser芍 el movimiento
        setbuf(stdin, NULL);	  	
        if (kbhit())
        {
            gotoxy(0, N+2);			
