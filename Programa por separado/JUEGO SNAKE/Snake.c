...
void Draw(char **snake, int len)    //Movimiento de serpiente
{
    ...
    if (tail[2]) //Si el numero de colas de serpiente no es 0, despues de comer la manzana, la cuadr¨ªcula detras de la cola de serpiente se agregar¨¢ al cuerpo de la serpiente.
    {  
		color(14); 
        printf("¡ï");//cuerpo ¡ï
        color(11);
